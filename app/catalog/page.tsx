        ...
        <header className="container mx-auto px-4 py-8">
          ...
          <div className="space-y-3 text-lg text-gray-600">
            ...
            <p className="text-sm text-gray-500">
              ...
              <abbr title="Лёгкий блок с высокой теплоизоляцией, подходит для наружных стен энергоэффективных домов">D400</abbr>
              –
              <abbr title="Плотность для несущих стен, сочетает прочность и теплоэффективность">D500</abbr> толщиной 300–400 мм.
              Для перегородок часто используют блоки 100–150 мм плотности{' '}
              <abbr title="Лёгкие блоки для внутренних перегородок и мансард">D300–D350</abbr>. Настройте фильтры ниже, чтобы
              подобрать решение под ваш проект.
            </p>
          </div>
        </header>
