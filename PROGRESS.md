...
**Статус:** Базовый набор Schema.org внедрён на ключевых страницах (главная, /construction, /faq, /contacts, доставка), все схемы проходят structured-data-testing-tool
...
- [x] `app/construction/page.tsx` — раздел "Строительство из газобетона" (оглавление, секции и ссылки-плейсхолдеры на статьи)
